...
//				}
	...
	private void refreshControls() {
		Calendar cal = new GregorianCalendar(TimeZone.getTimeZone("GMT+0400"), new Locale("RU"));
        tvMonth.setText(DateUtils.getMonthString(mView.getMonth(), DateUtils.LENGTH_LONG) + " " + mView.getYear());
		if((mView.getMonth() <= cal.get(Calendar.MONTH) & mView.getYear() == cal.get(Calendar.YEAR))
				|| mView.getYear() < cal.get(Calendar.YEAR)) {
